      ...
      <body className={playfair.className}>
        ...
        <div className="nav fixed w-full h-24  flex items-center justify-between px-0 py-4 z-50">
          <div className="items-left ml-10">
            <a className="no-underline font-bold  px-5 py-2 text-base border border-black rounded-full transition ease-out hover:bg-slate-100" href="/kuliner">kuliner</a>
            <a className="no-underline font-bold  px-5 py-2 text-base border border-black rounded-full transition ease-out hover:bg-slate-100" href="/etnis">suku</a>
          </div>
          <div className="items-right mr-10">
            ...
            <a className="no-underline font-bold  px-5 py-2 text-base border border-black rounded-full transition ease-out hover:bg-slate-100" href="/agama">agama</a>
          </div>
        </div>
        ...
        <footer className="footer footer-center p-4 bg-black text-base-content">
          <aside>
            <p className="text-white">Copyright © 2024 - All right reserved by Libur Enjoyer</p>
          </aside>
        </footer>
